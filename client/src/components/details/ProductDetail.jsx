...
import { Grid, styled, Box, Typography, Table, TableBody, TableRow, TableCell } from "@mui/material";
  ...
  return (
    <>
      ...
      <SmallText>
        ...
        <Typography><StyledBadge/>10% instant discount on IDFC FIRST Credit Card EMI Trxns, up to ₹3000 on orders of ₹5,000 and above T&C</Typography>
        <Typography><StyledBadge/>Buy this product and get upto ₹500 off on Flipkart Furniture Know More</Typography>
      </SmallText>
      <Table>
         <TableBody>
            <ColumnText>
